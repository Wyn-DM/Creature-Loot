...
<div class='footnote'>A | Angel - Azer</div>
...
<div class='footnote'>D | Demilich - Demon</div>
...
- **1d4 Hezrou Claws.** Requires Attunment. Acts as a magical dagger that deals an additional 3 (1d6) poison damage on a hit.
...
<div class='footnote'>D | Demon - Devil</div>
...
<div class='footnote'>D | Devil</div>
...
<div class='footnote'>D | Devil - Dinosaur</div>
...
<div class='footnote'>D | Dragon (Green)</div>
...
<div class='footnote'>D | Dragon (Red)</div>
...
<div class='footnote'>D | Dragon (White)</div>
...
<div class='footnote'>D | Dragon (Brass)</div>
...
<div class='footnote'>D | Dragon (Bronze)</div>
...
<div class='footnote'>D | Dragon (Copper)</div>
...
<div class='footnote'>D | Dragon (Gold)</div>
...
<div class='footnote'>D | Dragon (Silver)</div>
...
<div class='footnote'>D | Dragon - Duergar</div>
...
<img 
  src='https://www.gmbinder.com/images/28NVNf9.png' 
  style='position:absolute; top:37px; left:358px; width:100px; filter:brightness(100%)contrast(100%) grayscale(0%)hue-rotate(0deg) opacity(100%)saturate(100%)sepia(0%);' />
...
<div class='footnote'>E | Elemental</div>
...
- **2 Poisoned Shortswords.** Requires Attunement When they successfully hit a creature for the first time, that creature takes an additional 10 (3d6) poison damage.
...
<div class='footnote'>E | Empyrean - Ettin</div>
...
<img 
  src='https://www.gmbinder.com/images/Oyrhmqy.png' 
  style='position:absolute; top:37px; left:355px; width:100px; filter:brightness(100%)contrast(100%) grayscale(0%)hue-rotate(0deg) opacity(100%)saturate(100%)sepia(0%);' />
...
<div class='footnote'>F | Faerie Dragon - Flumph</div>
...
<div class='footnote'>F | Fomorian - Fungus</div>
...
<img 
  src='https://www.gmbinder.com/images/fRyiQn4.png' 
  style='position:absolute; top:37px; left:355px; width:100px; filter:brightness(100%)contrast(100%) grayscale(0%)hue-rotate(0deg) opacity(100%)saturate(100%)sepia(0%);' />
...
*Elemental (arcana)*
___
- **1 Maul of Elemental Earth.** Requires attunement. Acts as a magical Maul. On a hit, if the target is a Huge or smaller creature, they must succeed on a DC 18 Strength saving throw or be knocked prone.
...
*Elemental (arcana)*
___
- **1 Scimitar of Elemental Air.** Requires attunement. Acts as a magical Scimitar. On a hit, it deals an additional 1d6 thunder or lightning damage (wielder’s choice).
...
<div class='footnote'>G | Galeb Duhr - Genie</div>
...
<div class='footnote'>G | Genie - Giant</div>
...
- **2 Vials of Githyanki Blood.** When consumed as an action, acts as a Non-detection spell requiring no other material components.
...
<div class='footnote'>G | Giant - Gith</div>
...
<div class='footnote'>G | Gnoll - Golem</div>
...
*Aberration (arcana)*
___
- **2d4 Grell Tentacles.** Acts as a whip. Can be carefully crafted (leatherworker’s tools) into a Grell Tentacle Whip, On a hit, a target must succeed on a DC 11 Constitution saving throw or be poisoned for 1 minute. The poisoned target is also paralyzed, and it can repeat the saving throw at the end of each of its turns, ending the effect on a success. Once the tentacle has poisoned a target, it loses this property.
- **Grell Beak.** Acts as a sickle. Can be carefully crafted (alchemist’s supplies) into a Potion of Lightning Resistance.

### Grick (2) 
*Monstrosity (Survival)*
___
- **1d4 Grick Tentacles.** Acts as a club. Can be carefully crafted (leatherworker’s tools) into a Grick Tentacle Whip. On a hit, the target must make a DC 10 Strength saving throw or be grappled for one round. This effect ends if the attacker moves more than 5 feet away from the target.
...
*Monstrosity (Survival)*
___
- **2d4 Grick Tentacles.** Acts as a whip. Can be carefully crafted (leatherworker’s tools) into a Grick Tentacle Whip On a hit, the target must make a DC 12 Strength saving throw or be grappled for one round. This effect ends if the attacker moves more than 10 feet away from the target.
- **1 Grick Hide.** No immediate use. Can be crafted (leatherworker’s tools) into a cloak that grants advantage on stealth checks made to hide in rocky terrain.
...
<div class='footnote'>G | Golem - Grick Alpha</div>
...
<div class='footnote'>G | Griffon - Grimlock</div>
...
<img 
  src='https://www.gmbinder.com/images/N8NamlT.png' 
  style='position:absolute; top:37px; left:355px; width:100px; filter:brightness(100%)contrast(100%) grayscale(0%)hue-rotate(0deg) opacity(100%)saturate(100%)sepia(0%);' />
...
*Monstrosity (Survival)*
___
- **1d6 Harpy Feathers.** No immediate use. Can be crafted (calligrapher’s supplies) into a pen that can write enchanted love letters (disadvantage to resist their charms).
...
<div class='footnote'>H | Hag - Hell Hound</div>
...
- **2 Gauntlets of Horror.** Requires attunement. When worn, your unarmed attacks deal 1d6 damage on a hit, and are considered adamantine for the purpose of overcoming immunities.
...
- **1d10 Hippogriff Feathers.** No immediate use. Can be minor crafted (calligraphy tools) into a pen, or minor crafted (woodcarver’s tools) into 2 arrows
...
<div class='footnote'>H | Helmed Horror - Hydra</div>
...
<img 
  src='https://www.gmbinder.com/images/xWI93aa.png' 
  style='position:absolute; top:37px; left:355px; width:100px; filter:brightness(100%)contrast(100%) grayscale(0%)hue-rotate(0deg) opacity(100%)saturate(100%)sepia(0%);' />
...
<div class='footnote'>I | Intellect Devourer - Invisible Stalker</div>
...
<img 
  src='https://www.gmbinder.com/images/GgIzsun.png' 
  style='position:absolute; top:37px; left:350px; width:100px; filter:brightness(100%)contrast(100%) grayscale(0%)hue-rotate(0deg) opacity(100%)saturate(100%)sepia(0%);' />
...
<div class='footnote'>J | Jackalwere</div>
...
<img 
  src='https://www.gmbinder.com/images/OcObsWl.png' 
  style='position:absolute; top:37px; left:350px; width:100px; filter:brightness(100%)contrast(100%) grayscale(0%)hue-rotate(0deg) opacity(100%)saturate(100%)sepia(0%);' />
  
### Kenku (1/4) 
*Humanoid (Medicine)*
___
- **1d4 Kenku Feathers.** No immediate use. Can be minor crafted (calligrapher's supplies) into a pen, or minor crafted (woodcarver’s tools) into 2 arrows.
...
*Monstrosity (Survival)*
___
- **2d10 Kraken Scales.** Requires attunement. Acts as a shield that grants advantage on Dexterity saving throws made to avoid taking lightning damage. 10 of these can be mastercrafted (smith’s tools) into Armor of Invulnerability.
...
<div class='footnote'>K | Kenku - Kraken</div>
...
*Humanoid (Medicine)*
___
- **1 Tattered Pincer Staff.** Requires attunement. If repaired, a creature hit by this staff takes 1d6 piercing damage and is grappled (escape DC 14) if it is medium or smaller. Until the grapple ends, the pincer staff cannot be used on another target.
- **1 Kuo-Toa Hide.** No immediate use. 3 can be carefully crafted (leatherworker’s  tools) into a cloak that grants advantage on ability checks and saving throws made to escape a grapple.

<div class='footnote'>K | Kuo-Toa</div>
...
<img 
  src='https://www.gmbinder.com/images/B7AUyR6.png' 
  style='position:absolute; top:37px; left:358px; width:100px; filter:brightness(100%)contrast(100%) grayscale(0%)hue-rotate(0deg) opacity(100%)saturate(100%)sepia(0%);' />
...
- **1 Left Hand of the Lich.** Requires attunement. Acts as an improvised melee weapon. On a hit, a target takes 3d6 cold damage and must succeed on a DC 18 Constitution saving throw or be paralyzed for 1 minute. The creature can repeat the saving throw at the end of each of its turns, ending the effect on itself on a success. If the creature’s saving throw is successful or the effect ends for it, the creature is immune to this effect for the next 24 hours.
...
<div class='footnote'>L | Lamia - Lizardfolk</div>
...
<div class='footnote'>L | Lizardfolk - Lycanthrope</div>
...
<img 
  src='https://www.gmbinder.com/images/q4wXoxt.png' 
  style='position:absolute; top:37px; left:352px; width:100px; filter:brightness(100%)contrast(100%) grayscale(0%)hue-rotate(0deg) opacity(100%)saturate(100%)sepia(0%);' />
...
- **1d8 Manticore Teeth.** 20 teeth act as a bag of caltrops. Can be minor crafted (jeweler’s tools) into dice.
...
- **4d4 Medusa Snakes.** Requires attunement. Acts as a dagger that deals an additional 4d6 poison damage. This poison damage ignores the resistance granted by the petrified condition. If a petrified creature takes 25 poison damage from this weapon within 1 hour, the petrified condition ends for them. Once a snake has delivered its poison, it loses the additional poison damage.
...
*Humanoid (Medicine)*
___
- **1 Merfolk Hide.** No immediate use. Can be crafted (leatherworker’s tools) into a very beautiful cloak.

### Merrow (2) 
*Monstrosity (Survival)*
___
- **1 Tattered Harpoon**
- **1 Merrow Hide.** No immediate use. Can be crafted (leatherworker’s tools) into a very menacing cloak.
...
<div class='footnote'>M | Magmin - Merrow</div>
...
*Undead (religion)*
___
- **1 Rotting Hand.** Requires attunement. Acts as an improvised weapon. A creature hit by the hand must succeed on a DC 12 Constitution saving throw or be cursed with mummy rot. The cursed target can’t regain hit points, and its hit point maximum decreases by 10 (3d6) for every 24 hours that elapse. If the curse reduces the target’s hit point maximum to 0, the target dies, and its body turns to dust. The curse lasts until removed by the Remove Curse spell or other magic. After 24 hours, if the Heart of the Mummy still exists, the Rotting Hand becomes a Crawling Claw whose attacks gain the properties of the Rotting Hand.
...
<div class='footnote'>M | Mimic - Mummy</div>
...
<div class='footnote'>M | Mummy Lord - Myconid</div>
...
<img 
  src='https://www.gmbinder.com/images/OJtC4w9.png' 
  style='position:absolute; top:30px; left:365px; width:100px; filter:brightness(100%)contrast(100%) grayscale(0%)hue-rotate(0deg) opacity(100%)saturate(100%)sepia(0%);' />
...
*Undead (religion)*
___
- **2d4 Naga Fangs.** Acts as a dagger. Can be carefully crafted (leatherworker’s tools) into a Naga Fang Dagger that deals an additional 1d6 poison damage on a hit.
...
*Monstrosity (Survival)*
___
- **3d4 Naga Fangs.** Acts as a dagger. Can be carefully crafted (leatherworker’s tools) into a Naga Fang Dagger that deals an additional 1d6 poison damage on a hit.
...
*Aberration (arcana)*
___
- **1 Nothic Eye.** Requires attunement. As an action, a creature holding the eye can force another creature within 30 feet to make a DC 12 Constitution saving throw. On a failure, the target takes 3d6 necrotic damage. Can be carefully crafted (alchemist’s supplies) into a Potion of Truesight, which confers Truesight out to 120 feet. Can be mastercrafted by a spellcaster (divination) into a staff that requires attunement. An attuned creature can use its action to force a contest between its Wisdom (Insight) and a creature’s Charisma (Deception) within 30 feet. If the attuned creature wins, it magically learns one fact or secret about the target. The target automatically wins if it is immune to being charmed.
...
<div class='footnote'>N | Naga - Nothic</div>
...
<img 
  src='https://www.gmbinder.com/images/adeRr5d.png' 
  style='position:absolute; top:37px; left:360px; width:100px; filter:brightness(100%)contrast(100%) grayscale(0%)hue-rotate(0deg) opacity(100%)saturate(100%)sepia(0%);' />
...
*Ooze (arcana)*
___
- **4d4 Gobs of Black Goo.** Can be used as a ranged weapon with a range of 20/60 by using a stone mechanism. On a hit, The Black Goo sticks to the target for 3 rounds, dealing 14 (4d6) acid damage a round and lowering the target’s AC permanently by 1. It will also eat though up to 6 inches of nonmagical metal or wood. Goo is consumed on use, hit or miss.

### Gelatinous Cube (2) 
*Ooze (arcana)*
___
- **2d4 Hunks of Blue Gel.** Can be used as a ranged weapon with a range of 20/60 by using a stone or metal mechanism. On a hit, the Blue Gel sticks to the target for 5 rounds, dealing 10 (3d6) acid damage a round. Gel is consumed on use, hit or miss.
...
*Ooze (arcana)*
___
- **1d4 vials of Grey Mush.** Can be used as a ranged weapon with a range of 20/60 by using a stone mechanism. On a hit, the Grey mush sticks to the target for 2 rounds, dealing 3 (1d6) acid damage a round and lowering the target’s AC permanently by 1. It will also eat though up to 6 inches of nonmagical metal. Mush is consumed on use, hit or miss.

### Ochre Jelly (2) 
*Ooze (arcana)*
___
- **2d4 Dollops of Orange Jelly.** Can be used as a ranged weapon with a range of 20/60 by using a non-organic mechanism. On a hit, the Orange Jelly sticks to the target for 2 rounds, dealing 7 (2d6) acid damage a round. Jelly is consumed on use, hit or miss. Can be carefully crafted (alchemist’s supplies) into a potion of lightning resistance.
...
<div class='footnote'>O | Ogre - Orc</div>
...
*Aberration (arcana)*
___
- **2 Otyugh Tentacles.** Acts as a whip. Can be carefully crafted (leatherworker’s tools) into a Otyugh Tentacle Whip that deals 1d8 bludgeoning damage and 1d4 piercing damage on a hit. It has the Heavy property instead of the Light property.
...
*Monstrosity (Survival)*
___
- **1d8 Owlbear Feathers.** No immediate use. Can be minor crafted (calligrapher's supplies) into a pen, or carefully crafted (woodcarver’s tools) into 2 arrows.
- **1 Owlbear Hide.** Acts as a blanket.  Can be minor crafted (leatherworker’s tools) into a cloak.
- **1d8 Owlbear Claws.** Acts as a dagger.

<div class='footnote'>O | Orc - Owlbear</div>
...
<img 
  src='https://www.gmbinder.com/images/EEhcrSR.png' 
  style='position:absolute; top:34px; left:360px; width:100px; filter:brightness(100%)contrast(100%) grayscale(0%)hue-rotate(0deg) opacity(100%)saturate(100%)sepia(0%);' />
...
- **1d4 Pegasus Feathers.** No immediate use. Can be minor crafted (calligrapher's supplies) into a pen, or crafted (woodcarver’s tools) into 2 arrows. Arrows made from Pegasus Feathers deal an additional 1d8 radiant damage when they strike Fiends, or 1d12 radiant damage if they strike a Nightmare.
...
<div class='footnote'>P | Pegasus - Purple Worm</div>
...
<img 
  src='https://www.gmbinder.com/images/O1AhfzL.png' 
  style='position:absolute; top:37px; left:360px; width:100px; filter:brightness(100%)contrast(100%) grayscale(0%)hue-rotate(0deg) opacity(100%)saturate(100%)sepia(0%);' />
...
<div class='footnote'>Q | Quaggoth</div>
...
<img 
  src='https://www.gmbinder.com/images/w66eIuZ.png' 
  style='position:absolute; top:32px; left:353px; width:100px; filter:brightness(100%)contrast(100%) grayscale(0%)hue-rotate(0deg) opacity(100%)saturate(100%)sepia(0%);' />
...
<div class='footnote'>R | Rakshasa - Remorhaz</div>
...
<div class='footnote'>R | Revenant - Rust Monster</div>
...
<img 
  src='https://www.gmbinder.com/images/YEoe0PP.png' 
  style='position:absolute; top:39px; left:357px; width:100px; filter:brightness(100%)contrast(100%) grayscale(0%)hue-rotate(0deg) opacity(100%)saturate(100%)sepia(0%);' />
...
*Elemental (arcana)*
___
- **1 Heated Spear.** Requires attunement. Acts as a spear that deals an additional 1d6 Fire damage on a hit.
...
- **1d2 Satyr’s Horn.** No immediate use. Can be carefully crafted (woodcarver’s tools) into one of the following items:
    - **A smoking pipe that creates pleasant smoke.** Requires attunement. Requires attunement. Requires attunement. Once per day, the user may cast Charm Person (save DC 13) on a target breathing the smoke.
    - **A flute that plays gentle music.** Requires attunement. Requires attunement. Once per day, the user may play the flute, and any creature within 60 feet that can hear the flute must succeed on a DC 13 Wisdom saving throw or fall asleep and become unconscious for 1 minute. The affect ends if the creature takes damage or is shaken awake, or if the user doesn’t use their action that round to continue to play the flute.
    - **A small horn that creates a frighteningly loud sound.** Requires attunement. Once per day, the user may blow into the horn and cast Fear (save DC 13).
...
<div class='footnote'>S | Sahuagin - Scarecrow</div>
...
- **2 Shield Guardian Gauntlets.** Requires attunement. Acts as a shield. A creature wearing the gauntlet gains the attack action of hitting an enemy with the gauntleted fist, dealing 1d6 bludgeoning damage on a hit.
...
<div class='footnote'>S | Shadow - Slaadi</div>
...
- **2 Blue Slaadi Hooks.** Acts as a sickle. When it successfully hits a creature for the first time, that creature must succeed on a DC 15 Constitution saving throw or be infected with a disease called chaos phage. While infected, the target can't regain hit points, and its hit point maximum is reduced by 10 (3d6) every 24 hours. If the disease reduces the target's hit point maximum to 0, the target instantly transforms into a red slaad or, if it has the ability to cast spells of 3rd level or higher, a green slaad. Only a wish spell can reverse the transformation. Once the sickle is used in this manner, it loses this property.
- **1 Control Gem.** No immediate use. Can be used to control the Slaad whose head it inhabits if removed by 9th level magic or careful surgery, without killing the Slaad. Can be crushed as a reaction to negate one roll on the Wild Magic Table.
...
- **1d4 Slaad Egg.** No immediate use. If ingested by a humanoid, the egg causes a disease in the host. Over three months, the egg moves to the chest cavity, gestates, and forms a slaad tadpole. In the 24-hour period before giving birth, the host starts to feel unwell, its speed is halved, and it has disadvantage on attack rolls, ability checks, and saving throws. At birth, the tadpole chews its way through vital organs and out of the host's chest in 1 round, killing the host in the process. If the disease is cured before the tadpole's emergence, the unborn slaad is disintegrated.
- **1d2 Slaad Eyes.** If ingested, grants the user telepathy out to 60 feet for one hour. At the end of this time, the user must roll on the Wild Magic table (PHB pg. 104).
- **2d4 Slaad Claws.** Requires attunement. Acts as a dagger. The first time it lands a hit on a creature, that creature must roll on the Wild Magic table (PHB pg. 104).
...
- **1 Slaad Chaos Staff.** Requires attunement. Acts as a Wand of the War Mage +2 in the hands of a Wild Magic Sorcerer. Any other spellcasting class can use it as an Arcane Focus. When a spell is cast from this staff, roll on the Wild Magic table (PHB pg. 104), unless a Wild Magic surge has already been triggered due to the casting of the spell.
...
<div class='footnote'>S | Slaadi</div>
...
- **1 Sphinx Tail.** Requires attunement. Acts as a magic whip. A creature struck by the whip must succeed on a DC 15 Constitution saving throw or become 1d20 years older or younger (wielder’s choice), but never any younger than 1 year old. A Greater Restoration spell restores a creature’s age to normal.
...
*Beast (Survival)*
___
- **1 Stirge Stinger.** Acts as a piton, can be minor crafted into a pen (calligrapher's supplies)

<div class='footnote'>S | Specter - Stirge</div>
...
- **1d4 Succubus/Incubus Claws.** Requires attunement. Acts as a magic dagger. If two or more creatures each attune to a dagger from the same succubus/incubus, they are under the effect of a Rary’s Telepathic Bond spell.

<div class='footnote'>S | Succubus & Incubus</div>
...
<img 
  src='https://www.gmbinder.com/images/7Bk9D35.png' 
  style='position:absolute; top:39px; left:357px; width:100px; filter:brightness(100%)contrast(100%) grayscale(0%)hue-rotate(0deg) opacity(100%)saturate(100%)sepia(0%);' />
...
<div class='footnote'>T | Tarrasque</div>
...
<div class='footnote'>T | Thri-Kreen - Troll</div>
...
<div class='footnote'>U | Umber Hulk - Unicorn</div>
...
<img 
  src='https://www.gmbinder.com/images/gKjngey.png' 
  style='position:absolute; top:39px; left:357px; width:100px; filter:brightness(100%)contrast(100%) grayscale(0%)hue-rotate(0deg) opacity(100%)saturate(100%)sepia(0%);' />
...
<div class='footnote'>V | Vampire</div>
...
<img 
  src='https://www.gmbinder.com/images/14WWpsC.png' 
  style='position:absolute; top:39px; left:355px; width:100px; filter:brightness(100%)contrast(100%) grayscale(0%)hue-rotate(0deg) opacity(100%)saturate(100%)sepia(0%);' />
...
<div class='footnote'>W | Water Weird - Wyvern</div>
...
<img 
  src='https://www.gmbinder.com/images/ojIYjh0.png' 
  style='position:absolute; top:39px; left:355px; width:100px; filter:brightness(100%)contrast(100%) grayscale(0%)hue-rotate(0deg) opacity(100%)saturate(100%)sepia(0%);' />
...
<img 
  src='https://www.gmbinder.com/images/Gi1ePwY.png' 
  style='position:absolute; top:39px; left:358px; width:100px; filter:brightness(100%)contrast(100%) grayscale(0%)hue-rotate(0deg) opacity(100%)saturate(100%)sepia(0%);' />
...
- **2 Fangs of the Yuan-Ti.** Requires attunement. Acts as a dagger that deals an additional 2d6 poison damage on a hit. Acts as a trophy for rangers and adventurers.
...
- **1 Fang of the Yuan-Ti.** Requires attunement. Acts as a dagger that deals an additional 2d6 poison damage on a hit. Acts as a trophy for rangers and adventurers.
- **1d4 Vials of Yuan-Ti Blood.** When ingested, a creature must succeed a DC 10 Constitution saving throw or become poisoned for 1 hour. While poisoned in this way, the creature is immune to poison damage, and cannot be poisoned by any other effect. Any poisons currently affecting the creature are suppressed until the effects of this poison wear off.

<div class='footnote'>Y | Yeti - Yuan-Ti</div>
...
<div class='footnote'>Y | Yuan-Ti - Yugoloth</div>
...
<img 
  src='https://www.gmbinder.com/images/0ZTFNVs.png' 
  style='position:absolute; top:39px; left:358px; width:100px; filter:brightness(100%)contrast(100%) grayscale(0%)hue-rotate(0deg) opacity(100%)saturate(100%)sepia(0%);' />
...
*Undead (religion)*
___
- **2 Small Beholder Eyes.**  Requires attunement. Acts as an arcane focus. An eye can cast a particular zombie beholder ray once per day. The ray is chosen randomly by the DM upon receiving the eye.
- **1 Vial of Beholder Slime.** Acts as Oil of Slipperiness.
- **1 Zombified Beholder Eyestalk.** Acts as an arcane focus when casting necromancy spells.

<div class='footnote'>Z | Zombie</div>
...
*Beast (Survival)*
___
- **1 Ape Hide.** Acts as a blanket.  Can be minor crafted (leatherworker’s tools) into a cloak.
...
*Beast (Survival)*
___
- **1 Baboon Pelt.** No immediate use. Can be minor crafted (leatherworker’s tools) into a pouch or minor crafted (leatherworker’s tools) into a water skin.

### Badger (0)
*Beast (Survival)*
___
- **1 Badger Pelt.** No immediate use. Can be minor crafted (leatherworker’s tools) into a pouch or minor crafted (leatherworker’s tools) into a water skin.

### Bat (0) 
*Beast (Survival)*
___
- **1 Bat Pelt.** No immediate use. Can be minor crafted (leatherworker’s tools) into a pouch or minor crafted (leatherworker’s tools) into a water skin.

### Black Bear (1/2)
*Beast (Survival)*
___
- **1 Black Bear Hide.** Acts as a blanket.  Can be minor crafted (leatherworker’s tools) into a cloak.
...
*Beast (Survival)*
___
- **1d4 Blood Hawk Feathers.** No immediate use. Can be minor minor crafted (calligrapher's supplies) into a pen, or minor crafted (woodcarver’s tools) into 2 arrows.

### Boar (1/4)
*Beast (Survival)*
___
- **1 Boar Hide.** Acts as a small blanket.  2 hides can be minor crafted (leatherworker’s tools) into a cloak.
...
*Beast (Survival)*
___
- **1 Camel Hide.** Acts as a blanket.  Can be minor minor minor crafted (leatherworker’s tools) into a cloak.

### Cat (0)
*Beast (Survival)*
___
- **1 cat pelt.** No immediate use. Can be minor minor crafted (leatherworker’s tools) into a pouch or minor crafted (leatherworker’s tools) into a water skin.

### Constrictor Snake (1/4)
*Beast (Survival)*
___
- **1 Snake Skin.** No immediate use. Can be minor crafted (leatherworker’s tools) into a pouch or minor crafted (leatherworker’s tools) into a water skin.
...
*Beast (Survival)*
___
- **1d10 Crocodile Teeth.** 20 teeth act as a bag of caltrops. Can be crafted (jeweler’s tools) into dice.
...
<div class='footnote'>Appendix I | Ape - Death Dog</div>
...
*Beast (Survival)*
___
- **1 Deer Pelt.** No immediate use. Can be minor minor crafted (leatherworker’s tools) into a pouch or minor crafted (leatherworker’s tools) into a water skin.
...
*Beast (Survival)*
___
- **1d4 Hooves.** Acts as a hammer. Can be crafted (jeweler’s tools) into 1d6 dice.

### Eagle (0) 
*Beast (Survival)*
___
- **1d4 Eagle Feathers.** No immediate use. Can be minor crafted (calligrapher's supplies) into a pen, or minor crafted (woodcarver’s tools) into 2 arrows.
...
- **2d4 Elephant Toes.** No immediate use. Can be crafted (jeweler’s tools) into dice.
...
*Beast (Survival)*
___
- **1d4 Snake Feathers.** No immediate use. Can be minor crafted (calligrapher's supplies) into a pen, or minor crafted (woodcarver’s tools) into 2 arrows.
...
- **2 Giant Ape Fangs.** acts as a druidic focus. Can be minor crafted (leatherworker’s tools) into a dagger.

### Giant Badger (1/4) 
*Beast (Survival)*
___
- **1 Giant Badger Hide.** Acts as a blanket.  Can be minor minor crafted (leatherworker’s tools) into a cloak.

### Giant Bat (1/4) 
*Beast (Survival)*
___
- **1 Giant Bat Hide.** Acts as a blanket.  Can be minor crafted (leatherworker’s tools) into a cloak.
...
*Beast (Survival)*
___
- **2 Snake Skin.** No immediate use. Can be minor minor crafted (leatherworker’s tools) into a pouch or minor crafted (leatherworker’s tools) into a water skin.

### Giant Crab (1/8)
*Beast (Survival)*
___
- **1 Giant Crab Claw.** Acts as a dagger. Can be crafted (jeweler’s tools) into a musical instrument.
...
<div class='footnote'>Appendix I | Deer - Giant Crocodile</div>
...
*Beast (Survival)*
___
- **1d10 Giant Eagle Feathers.** No immediate use. Can be minor crafted (calligrapher's supplies) into a pen, or minor crafted (woodcarver’s tools) into 2 arrows.

### Giant Elk (2) 
*Beast (Survival)*
___
- **1 Giant Elk Hide.** Acts as a blanket.  Can be minor crafted (leatherworker’s tools) into a cloak.
...
*Beast (Survival)*
___
- **1 Giant Goat Hide.** Acts as a blanket.  Can be minor crafted (leatherworker’s tools) into a cloak.
...
*Beast (Survival)*
___
- **1d8 Giant Owl Feathers.** No immediate use. Can be minor crafted (calligrapher's supplies) into a pen, or minor crafted (woodcarver’s tools) into 2 arrows.
...
*Beast (Survival)*
___
- **1d6 Poisonous Snake Skin.** No immediate use. Can be minor crafted (leatherworker’s tools) into a pouch or minor crafted (leatherworker’s tools) into a poisoned water skin (contains 1 dose of basic poison instead of water).
- **1 Vial of Serpent Venom.** Acts as basic poison (PHB pg. 153) but deals 3d6 poison damage upon taking effect.

### Giant Rat (1/8)
*Beast (Survival)*
___
- **1 Giant Rat Hide.** Acts as a blanket.  Can be minor crafted (leatherworker’s tools) into a cloak.

### Giant Scorpion (3) 
*Beast (Survival)*
___
- **2 Giant Scorpion Claw.** Acts as a dagger. Can be crafted (jeweler’s tools) into a musical instrument.
- **1 Giant Scorpion Stinger.** Requires attunement. Acts as a dagger that deals +1d6 poison damage.
...
*Beast (Survival)*
___
- **3d10 Shark Teeth.** 20 teeth act as a bag of caltrops. Can be crafted (jeweler’s tools) into dice.
- **2 Shark Fin.** No immediate use. Can be minor crafted (cook’s utensils) into a delicious soup.
...
*Beast (Survival)*
___
- **1d8 Giant Vulture Feathers.** No immediate use. Can be minor crafted (calligrapher's supplies) into a pen, or minor crafted (woodcarver’s tools) into 2 arrows.
...
*Beast (Survival)*
___
- **1 Giant Weasel Hide.** Acts as a blanket.  Can be minor crafted (leatherworker’s tools) into a cloak.

<div class='footnote'>Appendix I | Giant Eagle - Giant Weasel</div>
...
*Beast (Survival)*
___
- **1 Goat Pelt.** No immediate use. Can be minor crafted (leatherworker’s tools) into a pouch or minor crafted (leatherworker’s tools) into a water skin.

### Hawk (0)
*Beast (Survival)*
___
- **1d4 Hawk Feathers.** No immediate use. Can be minor crafted (calligrapher's supplies) into a pen, or minor crafted (woodcarver’s tools) into 2 arrows.

### Hunter Shark (2)
*Beast (Survival)*
___
- **1d10 Shark Teeth.** 20 teeth act as a bag of caltrops. Can be crafted (jeweler’s tools) into dice.
- **1 Shark Fin.** No immediate use. Can be minor crafted (cook’s utensils) into a delicious soup.

### Hyena (0)
*Beast (Survival)*
___
- **1 Hyena Pelt.** No immediate use. Can be minor crafted (leatherworker’s tools) into a pouch or minor crafted (leatherworker’s tools) into a water skin.

### Jackal (0)
*Beast (Survival)*
___
- **1 Jackal Pelt.** No immediate use. Can be minor crafted (leatherworker’s tools) into a pouch or minor crafted (leatherworker’s tools) into a water skin.
...
*Beast (Survival)*
___
- **1 Mastiff Hide.** Acts as a blanket.  2 hides can be minor crafted (leatherworker’s tools) into a cloak.

### Mule (1/8)
*Beast (Survival)*
___
- **1 Mule Hide.** Acts as a blanket.  2 hides can be minor crafted (leatherworker’s tools) into a cloak.
...
*Beast (Survival)*
___
- **1d4 owl feathers.** No immediate use. Can be minor crafted (calligrapher's supplies) into a pen, or minor crafted (woodcarver’s tools) into 2 arrows.

### Panther (1/4)
*Beast (Survival)*
___
- **1 Panther Hide.** Acts as a blanket.  2 hides can be minor crafted (leatherworker’s tools) into a cloak.
...
*Beast (Survival)*
___
- **1 Poisonous Snake Skin.** No immediate use. Can be minor crafted (leatherworker’s tools) into a pouch or minor crafted (leatherworker’s tools) into a poisoned water skin (contains 1 dose of basic poison instead of water).

<div class='footnote'>Appendix I | Giant Wolf Spider - Poisonous Snake</div>
...
- **1d8 Polar Bear Teeth.** 20 teeth act as a bag of caltrops. Can be crafted (jeweler’s tools) into dice.

### Pony (1/8)
*Beast (Survival)*
___
- **1 Pony Hide.** No immediate use. Can be minor crafted (leatherworker’s tools) into a pouch or minor crafted (leatherworker’s tools) into a water skin.
...
*Beast (Survival)*
___
- **1 Rat Pelt.** No immediate use. Can be minor crafted (leatherworker’s tools) into a pouch or minor crafted (leatherworker’s tools) into a water skin.

### Raven (0) 
*Beast (Survival)*
___
- **1d4 Raven Feathers.** No immediate use. Can be minor crafted (calligrapher's supplies) into a pen, or minor crafted (woodcarver’s tools) into 2 arrows.

### Reef Shark (1/2)
*Beast (Survival)*
___
- **1d8 Shark Teeth.** 20 teeth act as a bag of caltrops. Can be crafted (jeweler’s tools) into dice.
...
- **1 Rhino Horn.** Acts as a club. Can be crafted (alchemist’s supplies) into a potion of healing.
...
*Beast (Survival)*
___
- **1d20 Bat Pelt.** No immediate use. Can be minor crafted (leatherworker’s tools) into a pouch or minor crafted (leatherworker’s tools) into a water skin.
...
*Beast (Survival)*
___
- **2d20 Poisonous Snake Skin.** No immediate use. Can be minor crafted (leatherworker’s tools) into a pouch or minor crafted (leatherworker’s tools) into a poisoned water skin (contains 1 dose of basic poison instead of water).
...
*Beast (Survival)*
___
- **1d20 Rat Pelt.** No immediate use. Can be minor crafted (leatherworker’s tools) into a pouch or minor crafted (leatherworker’s tools) into a water skin.

<div class='footnote'>Appendix I | Polar Bear - Swarm of Rats</div>
...
*Beast (Survival)*
___
- **1d20 Raven Feathers.** No immediate use. Can be minor crafted (calligrapher's supplies) into a pen, or minor crafted (woodcarver’s tools) into 2 arrows.

### Tiger (1)
*Beast (Survival)*
___
- **1 Tiger Hide.** Acts as a blanket.  Can be carefully crafted (leatherworker’s tools) into a cloak that grants resistance to cold damage. In extreme heat (DMG pg. 110), a creature wearing the cloak rolls Constitution saving throws to avoid exhaustion with disadvantage.

### Vulture (0)
*Beast (Survival)*
___
- **1d4 Vulture Feathers.** No immediate use. Can be minor crafted (calligrapher's supplies) into a pen, or minor crafted (woodcarver’s tools) into 2 arrows.

### Warhorse (1/2)
*Beast (Survival)*
___
- **1 Horse Hide.** No immediate use. Can be minor crafted (leatherworker’s tools) into a pouch or minor crafted (leatherworker’s tools) into a water skin.

### Weasel (0)
*Beast (Survival)*
___
- **1 Weasel Pelt.** No immediate use. Can be minor crafted (leatherworker’s tools) into a pouch or minor crafted (leatherworker’s tools) into a water skin.
...
*Beast (Survival)*
___
- **1 Wolf Hide.** Acts as a blanket. 2 hides can be minor crafted (leatherworker’s tools) into a cloak.

### Worg (1/2) 
*Monstrosity (Survival)*
___
- **1 Worg Hide.** Acts as a blanket.  Can be minor crafted (leatherworker’s tools) into a cloak.

<div class='footnote'>Appendix I | Swarm of Ravens - Worg</div>
...
<div class='footnote'>Appendix II | Acolyte - Guard</div>
...
<div class='footnote'>Appendix II | Knight - Veteran</div>
